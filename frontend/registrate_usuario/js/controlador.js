...
function enviar_informacion(e) {
    ...
    if (error_campos_vacios) {
        ...
        let casilla_nombre = inputNombre.value;
        let casilla_correo = inputCorreo.value;
        let casilla_cedula = inputCedula.value;
        let casilla_password = inputPassword.value;
        let casilla_direccion = inputDireccion.value;
